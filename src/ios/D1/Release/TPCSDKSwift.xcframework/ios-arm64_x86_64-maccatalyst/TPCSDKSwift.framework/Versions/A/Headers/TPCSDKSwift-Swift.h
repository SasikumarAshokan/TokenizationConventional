...
///
/// \endcode\param scheme Card scheme. Could be <code>VISA</code>, <code>MASTERCARD</code> or others.
///
...
///
+ (void)getCardDigitizationResultWithCard:(FundingCard * _Nullable)card primaryAccountIdentifier:(NSString * _Nullable)primaryAccountIdentifier primaryAccountNumberSuffix:(NSString * _Nullable)primaryAccountNumberSuffix completion:(void (^ _Nonnull)(NSString * _Nullable, CardDigitizationResult * _Nullable, NSError * _Nullable))completion;
...
/// warning:
/// This API is deprecated as it does not provide information about pending activation and Apple Watch status. Please use getCardDigitizationResult API instead.
...
/// Displays an interface that lets users add cards to Apple Pay from within your app.
/// note:
/// In case of Amex or Discover scheme, the SDK can not retrieve <code>primaryAccountIdentifier</code> from the server.
...
/// \param cardholderName The name of the person as shown on the card
///
/// \param schemeString Card’s scheme. Could be <code>VISA</code>, <code>MASTERCARD</code> or others. NOTE: It has to be UPPERCASE string
///
/// \param encryptedPayload Card information encrypted in PKCS7
///
/// \param authorizationCode Authorization code
...
///
/// \param primaryAccountIdentifier An FPANID for the card. If this parameter is not provided, the SDK will automatically retrieve it from the server for non-Amex/non-Discover schemes. For Amex/Discover schemes, please refer to the <code>Note</code> section for additional instructions.
///
/// \param provisionDelegate See <code>TPCSDKProvisionDelegate</code>
///
...
/// \param tokenRequestorId Unique identifier of the token requestor allocated by the TSP Scheme. It shall be provided for VISA scheme.
///
/// \param schemeString Card’s scheme. Could be <code>VISA</code>, <code>MASTERCARD</code> or others.
///
/// \param authorizationCode Authorization code provided by issuer.
///
/// \param action See <code>TokenState</code>
